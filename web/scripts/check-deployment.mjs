...
const HTML_ROUTES = ["/", "/rankings", "/portfolio", "/simulation", "/methodology", "/candidates", "/architecture", "/research", "/research/performance", "/research/experiments", "/about", "/disclosures"];
const DATA_ROUTES = ["/api/simulation/quotes", "/data/release_snapshot.json", "/data/release_rankings_snapshot.json", "/data/candidate_funnel_snapshot.json", "/data/hypothetical_account_snapshot.json", "/data/crisis_diversifier_research.json", "/data/drawdown_budget_research.json"];

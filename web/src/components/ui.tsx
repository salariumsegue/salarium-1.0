  ...
  return (
    <div className="grid gap-8 border-b border-white/10 pb-10 lg:grid-cols-[1fr_auto] lg:items-end">
      <div className="max-w-4xl">
        ...
        <h1 className="mt-5 max-w-[20ch] text-4xl font-semibold leading-[0.96] tracking-[-0.045em] sm:text-5xl lg:text-6xl">
          {title}{muted && <span className="block max-w-[18ch] text-white/48">{muted}</span>}
        </h1>

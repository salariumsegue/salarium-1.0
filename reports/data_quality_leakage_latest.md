...
**Summary:** Data quality and leakage status: warn. Universe tickers: 138. Training rows: 289527. Training tickers: 138. Suspicious leakage columns: 0. Warnings: 4. Errors: 0.
...
| `training_data_readable` | **pass** | Loaded 289527 rows from data/processed/training_data_model_safe_with_macro.csv |
...
| Training | Missing value ratio | 0.00277 |

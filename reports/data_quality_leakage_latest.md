...
**Summary:** Data quality and leakage status: warn. Universe tickers: 125. Training rows: 261993. Training tickers: 125. Suspicious leakage columns: 0. Warnings: 2. Errors: 0.
...
| `training_data_readable` | **pass** | Loaded 261993 rows from data/processed/training_data_top125_model_safe_with_global_macro.csv |
| `training_duplicate_date_ticker` | **pass** | No duplicate date/ticker rows. |
| `training_missing_values` | **pass** | Missing ratio 0.26%. |
...
| `leakage_zero_variance_features` | **warn** | Zero-variance columns: ['macro_signal_score', 'macro_tone_score', 'surprise_num', 'inflation_num', 'growth_num', 'rate_policy_num', 'liquidity_num', 'reaction_quality_num', 'five_day_market_bias_score', 'five_day_bias_num', 'macro_confidence', 'has_macro_context', 'days_since_macro_event'] |
...
| `macro_same_date_consistency` | **pass** | Macro columns are consistent across tickers by date. |
...
| Training | Missing value ratio | 0.002627 |
...
- Zero-variance numeric feature columns found: ['macro_signal_score', 'macro_tone_score', 'surprise_num', 'inflation_num', 'growth_num', 'rate_policy_num', 'liquidity_num', 'reaction_quality_num', 'five_day_market_bias_score', 'five_day_bias_num', 'macro_confidence', 'has_macro_context', 'days_since_macro_event']
